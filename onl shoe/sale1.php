	...
	<div id="content">
		...
		<div id="product">
			...
			include ('function/addcart.php');
				...
				$query = $conn->query("SELECT *FROM product WHERE category='sale' ORDER BY product_id DESC") or die (mysqli_error());
					...
					while($fetch = $query->fetch_array())
						...
						if($qty <= 5){
							...
							echo "<br />";
							echo "<span style='text-decoration: line-through'>150$</span>";
							echo " ";
							echo "<span style='color:#ff0000;'>".$fetch['product_price']."$</span>";
							echo "<br />";
