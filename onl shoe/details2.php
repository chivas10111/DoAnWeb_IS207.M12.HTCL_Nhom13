			...
			<div class="modal-header">
				...
				<div class="modal-body">
					<ul>
						...
						<li>All prices quoted are in USD. Price and availability information is subject to change without notice.</li>
						<li>Mode of payment are as follows:customers with paypal account can pay through paypal or Cash on Delivery(COD).</li>
					</ul>
				</div>
			<div class="modal-footer">
				<button class="btn btn-danger" data-dismiss="modal" aria-hidden="true">Close</button>
